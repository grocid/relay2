...
/*
			...
			select_channel.image = new Image.from_pixbuf(icon_buf);



			icon = new Image.from_file(Relay.get_asset_file("assets/mail-unread.svg"));
			channel_tab_icon_new_msg = icon.get_pixbuf().scale_simple (12, 12, InterpType.BILINEAR);
			...
			*/
			...
			icon_buf = icon.get_pixbuf().scale_simple (24, 24, InterpType.BILINEAR);

			channel_subject.image = new Image.from_pixbuf(icon_buf);
			...
			icon = new Image.from_file(Relay.get_asset_file("assets/users.svg"));
			icon_buf = icon.get_pixbuf().scale_simple (24, 24, InterpType.BILINEAR);

			channel_users.image = new Image.from_pixbuf(icon_buf);
			...
			Gtk.MenuItem private_message = new Gtk.MenuItem.with_label (_("Privat meddelande"));
...
*/
			...
			icon = new Image.from_file(Relay.get_asset_file("assets/upload.svg"));
			icon_buf = icon.get_pixbuf().scale_simple (24, 24, InterpType.BILINEAR);
			icon = new Image.from_pixbuf(icon_buf);
			paste.set_image(icon);
